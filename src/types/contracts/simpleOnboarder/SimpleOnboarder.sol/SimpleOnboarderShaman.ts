...
export interface SimpleOnboarderShamanInterface extends utils.Interface {
  functions: {
    "amounts(uint256)": FunctionFragment;
    "baal()": FunctionFragment;
    "cuts(uint256)": FunctionFragment;
    "expiery()": FunctionFragment;
    "init(address,address,uint256,bool,address[],uint256[])": FunctionFragment;
...
export interface SimpleOnboarderShaman extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleOnboarderShamanInterface;
