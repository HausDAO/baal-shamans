...
async function main() {
  ...
  const Onboarder = await ethers.getContractFactory("CappedOnboarderShaman");
  ...
  const OnboarderSummoner = await ethers.getContractFactory("CappedOnboarderShamanSummoner");
